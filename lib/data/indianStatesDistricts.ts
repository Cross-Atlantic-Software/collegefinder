 ...
 * Used for state and district selection in user profile
 */
...
export const indianStatesDistricts: State[] = [
  {
    name: "Andhra Pradesh",
    districts: [
  ...
  },
  {
    ...
    districts: [
      ...
      "Moga", "Muktsar", "Nawanshahr", "Pathankot", "Patiala", "Rupnagar", "Sangrur", "SAS Nagar",
...
export function getDistrictsForState(stateName: string): string[] {
  const state = indianStatesDistricts.find(s => s.name === stateName);
