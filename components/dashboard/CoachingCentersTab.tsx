...
function CoachingCenterCard({
  ...
  return (
    <div className="rounded-2xl bg-white p-4 text-slate-900 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:bg-slate-900 dark:text-slate-100">
      {/* Header */}
      ...
      <div className="mt-4 flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center justify-center rounded-full bg-slate-100 px-5 py-2.5 text-slate-700 transition-all duration-200 hover:bg-slate-200 hover:text-slate-900 active:scale-95 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
          aria-label="wishlist"
        >
          View
        </button>
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-all duration-200 hover:bg-slate-200 hover:text-slate-800 active:scale-95 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
          aria-label="wishlist"
        >
  ...
  return (
    <div className="space-y-4">
      <section className="grid gap-3 sm:grid-cols-3">
        {highlights.map((item) => (
          <div key={item.label} className="rounded-2xl bg-white p-4 shadow-sm dark:bg-slate-900">
            <p className="text-xs text-slate-500 dark:text-slate-400">{item.label}</p>
            <p className="mt-1 text-xl font-bold text-slate-900 dark:text-slate-100">{item.value}</p>
          </div>
        ))}
      </section>
