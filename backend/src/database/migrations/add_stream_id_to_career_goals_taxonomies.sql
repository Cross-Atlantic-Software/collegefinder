...
COMMENT ON COLUMN career_goals_taxonomies.stream_id IS 'Stream this interest applies to; onboarding shows only interests matching the user''s selected stream.';
