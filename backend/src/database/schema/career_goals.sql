...
-- Note: Index on status is created by migration file add_description_status_to_career_goals.sql
...
-- Note: Comments for description and status columns are added by migration file add_description_status_to_career_goals.sql
